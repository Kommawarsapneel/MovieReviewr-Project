...
// const Home = () => {
//   // Image URLs - replace these with your preferred movie images
...
//               />
//               <h3>{movie.title}</h3>
//               <div className="rating">⭐️ {Math.random().toFixed(1)}</div>
//             </div>
//           ))}
//         </div>
//       </section>
...
//                   <span className="rating">⭐️ {movie.rating}</span>
//                   <span className="author">by {movie.director}</span>
//                 </div>
